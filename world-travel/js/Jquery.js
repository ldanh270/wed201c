...
!(function (a, b) {
	...
	;(r.fn = r.prototype =
		...
		r.extend({
			...
			makeArray: function (a, b) {
				...
				return (
					null != a &&
						(w(Object(a)) ? r.merge(c, 'string' == typeof a ? [a] : a) : h.call(c, a)),
					c
				)
			},
		...
		return (
			...
			(i = ga.select =
				function (a, b, c, e) {
					...
					return (
						(m || h(a, n))(e, b, !p, c, !b || ($.test(a) && qa(b.parentNode)) || b), c
					)
				}),
	...
	function $(a) {
		return (
			'true' === a ||
			('false' !== a &&
				('null' === a ? null : a === +a + '' ? +a : Y.test(a) ? JSON.parse(a) : a))
		)
	}
	function _(a, b, c) {
		var d
				...
				while ((f = h[c++]) && !b.isPropagationStopped()) {
					...
					while ((g = f.handlers[d++]) && !b.isImmediatePropagationStopped())
						(b.rnamespace && !b.rnamespace.test(g.namespace)) ||
							((b.handleObj = g),
							(b.data = g.data),
							(e = ((r.event.special[g.origType] || {}).handle || g.handler).apply(
								f.elem,
								i
							)),
							void 0 !== e &&
	...
	function hb(a, b, c) {
		for (
			var d, e = (kb.tweeners[b] || []).concat(kb.tweeners['*']), f = 0, g = e.length;
			f < g;
			f++
		)
	...
	r.parseXML = function (b) {
		...
		return (
			(c && !c.getElementsByTagName('parsererror').length) || r.error('Invalid XML: ' + b), c
		)
	}
	var wb = /\[\]$/,
		xb = /\r?\n/g,
